...
function Layout({ children }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900">
      ...
      <footer className="bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 dark:from-gray-900 dark:via-black dark:to-gray-900 text-white py-12 mt-16">
        <div className="container mx-auto px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-amber-300 to-orange-300 dark:from-blue-300 dark:to-indigo-300 bg-clip-text text-transparent">
              Owlopedia
            </h3>
            <p className="text-gray-300 dark:text-gray-200 text-lg leading-relaxed max-w-2xl mx-auto mb-6">
