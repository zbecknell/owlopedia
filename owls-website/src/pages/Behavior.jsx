    ...
    <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 min-h-screen py-12">
      <div className="container mx-auto px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="content-card p-8 rounded-2xl">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Hunting & Feeding</h2>
            </div>
            <div className="space-y-4 text-gray-700 dark:text-gray-200 leading-relaxed">
              ...
              <div className="space-y-3">
                <div className="bg-amber-100 dark:bg-gray-700 p-4 rounded-lg border-l-4 border-amber-400 dark:border-blue-400">
                  <h4 className="font-semibold text-amber-800 dark:text-blue-300 mb-2">Silent Flight</h4>
                  <p className="text-amber-700 dark:text-blue-200 text-sm">Special feather structures allow owls to fly completely silently, giving them a crucial advantage when approaching prey.</p>
                </div>
                <div className="bg-orange-100 dark:bg-gray-700 p-4 rounded-lg border-l-4 border-orange-400 dark:border-indigo-400">
                  <h4 className="font-semibold text-orange-800 dark:text-indigo-300 mb-2">Exceptional Hearing</h4>
                  <p className="text-orange-700 dark:text-indigo-200 text-sm">Asymmetrical ear placement helps owls pinpoint prey location with incredible accuracy, even in complete darkness.</p>
                </div>
                <div className="bg-yellow-100 dark:bg-gray-700 p-4 rounded-lg border-l-4 border-yellow-400 dark:border-purple-400">
                  <h4 className="font-semibold text-yellow-800 dark:text-purple-300 mb-2">Powerful Talons</h4>
                  <p className="text-yellow-700 dark:text-purple-200 text-sm">Sharp, curved talons can exert pressure of up to 300 pounds per square inch, ensuring a secure grip on prey.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="content-card p-8 rounded-2xl">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Defense Strategies</h2>
            </div>
            <div className="space-y-4 text-gray-700 dark:text-gray-200 leading-relaxed">
              <p>
        ...
        <div className="content-card p-8 rounded-2xl mb-12">
          <div className="flex items-center mb-6">
            <span className="text-4xl mr-4">😴</span>
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Sleep & Activity Patterns</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Sleeping Habits</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Activity Cycles</h3>
              <div className="space-y-3 text-gray-700 dark:text-gray-200">
        ...
        <div className="content-card p-8 rounded-2xl mb-12">
          <div className="flex items-center mb-6">
            <span className="text-4xl mr-4">👨‍👩‍👧‍👦</span>
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Parental Care</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-gradient-to-br from-pink-100 to-pink-200 dark:from-gray-700 dark:to-gray-600 rounded-xl shadow-lg">
              ...
              <h3 className="text-lg font-bold text-pink-800 dark:text-pink-300 mb-3">Nesting</h3>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-green-100 to-green-200 dark:from-gray-700 dark:to-gray-600 rounded-xl shadow-lg">
              <span className="text-4xl mb-4 block">🐣</span>
              <h3 className="text-lg font-bold text-green-800 dark:text-green-300 mb-3">Feeding Young</h3>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-gray-700 dark:to-gray-600 rounded-xl shadow-lg">
              <span className="text-4xl mb-4 block">🦅</span>
              <h3 className="text-lg font-bold text-blue-800 dark:text-blue-300 mb-3">Fledging</h3>
        ...
        <div className="content-card p-8 rounded-2xl">
          <div className="flex items-center mb-6">
            <span className="text-4xl mr-4">🎭</span>
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Additional Behaviors</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-4 bg-gradient-to-br from-amber-100 to-amber-200 dark:from-gray-700 dark:to-gray-600 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-semibold text-amber-800 dark:text-amber-300 mb-2">Communication</h4>
              <p className="text-amber-700 dark:text-amber-200 text-xs">Owls use various hoots, screeches, and calls to communicate territory, attract mates, and warn of danger.</p>
            </div>
            ...
            <div className="text-center p-4 bg-gradient-to-br from-orange-100 to-orange-200 dark:from-gray-700 dark:to-gray-600 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-semibold text-orange-800 dark:text-orange-300 mb-2">Territory</h4>
              <p className="text-orange-700 dark:text-orange-200 text-xs">Most owls are territorial and will defend their hunting grounds from other owls of the same species.</p>
            </div>
            ...
            <div className="text-center p-4 bg-gradient-to-br from-yellow-100 to-yellow-200 dark:from-gray-700 dark:to-gray-600 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <span className="text-3xl mb-3 block">🔄</span>
              <h4 className="font-semibold text-yellow-800 dark:text-yellow-300 mb-2">Head Rotation</h4>
              <p className="text-yellow-700 dark:text-yellow-200 text-xs">Owls can rotate their heads up to 270 degrees due to having 14 neck vertebrae (humans have 7).</p>
            </div>
            ...
            <div className="text-center p-4 bg-gradient-to-br from-green-100 to-green-200 dark:from-gray-700 dark:to-gray-600 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <span className="text-3xl mb-3 block">🌨️</span>
              <h4 className="font-semibold text-green-800 dark:text-green-300 mb-2">Seasonal Behavior</h4>
              <p className="text-green-700 dark:text-green-200 text-xs">Some species migrate seasonally, while others adapt their behavior to survive harsh winter conditions.</p>
            </div>
          </div>
        </div>
      </div>
