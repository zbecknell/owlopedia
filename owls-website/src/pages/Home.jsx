    ...
    <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 min-h-screen transition-colors duration-500">
      ...
      <div className="flex">
        ...
        <div className="w-2/3 hero-section p-12 flex flex-col justify-center items-center min-h-96 relative transition-colors duration-500">
          ...
          <div className="w-full max-w-lg h-72 bg-gradient-to-br from-amber-100 to-amber-200 dark:from-gray-700 dark:to-gray-600 border-4 border-gray-700 dark:border-gray-300 rounded-2xl flex items-center justify-center mb-6 shadow-2xl overflow-hidden transform hover:scale-105 transition-all duration-500">
            <img 
      ...
      <div className="px-12 pb-20">
        ...
        <div className="flex justify-center space-x-12">
          ...
          <div className="text-center group">
            ...
            <span className="text-lg font-semibold text-gray-800 dark:text-gray-200 group-hover:text-amber-600 dark:group-hover:text-blue-400 transition-colors">Nesting</span>
          </div>
        </div>
      </div>
    </div>
